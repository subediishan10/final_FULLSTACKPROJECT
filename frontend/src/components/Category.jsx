...
function Categories() {
  ...
  const categories = [
    {
      name: "Fiction",
      icon: <BookOpen size={size} className={colorIcon} />,
    },
    {
      name: "Business",
    ...
    {
      name: "Fantasy",
      icon: <School size={size} className={colorIcon} />,
    },
    {
      name: "Mystery",
      icon: <HatGlasses size={size} className={colorIcon} />,
    },
    {
      name: "Educational",
      icon: <Search size={size} className={colorIcon} />,
    },
    {
      name: "Romance",
      icon: <Heart size={size} className={colorIcon} />,
    },
    {
      name: "Biography",
      icon: <Calendar size={size} className={colorIcon} />,
    },
    {
      name: "Children",
      icon: <Baby size={size} className={colorIcon} />,
    },
  ];
  return (
    <div className=" max-w-screen-2xl container mx-auto md:px-20 px-4 mt-25">
      ...
      <div className="text-center mb-12 ">
        ...
        <p className="text-gray-500">Explore books from your favorite genres</p>
      </div>
